      ...
      <div className="container mx-auto">
        <div className="flex -mx-6 py-8">
            <div className='w-2/3 px-6'>
              <p className='m-0 mb-5 text-xl'>Great choice! You're just moments away from booking your stay at <strong>{hotel.name}</strong> at <strong>{tourSpot.destination}</strong></p>
