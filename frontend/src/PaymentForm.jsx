...
const PaymentForm = function() {
    ...
    const validatePayment = Yup.object({
        ...
        validity: Yup.string().matches(/^(0[1-9]|1[0-2])\/?([0-9]{2})$/, "Enter in MM/YY format").required("Enter Validity Date on Card").test("is-valid-expiry", "Invalid or expired date", isValidExpiry),
        ...
        <form onSubmit={formik.handleSubmit}>
            <div className="flex -mx-2 md:-mx-4 flex-wrap">
                ...
                <div className="w-full sm:w-1/2 px-2 md:px-4 mb-3">
                    ...
                    <input type="text" maxLength={5} onChange={formik.handleChange} onBlur={formik.handleBlur} className='w-full px-2 py-2 border border-gray-300 rounded-sm' name="validity" id="validity" placeholder='MM/YY' value={formik.values.validity} />
